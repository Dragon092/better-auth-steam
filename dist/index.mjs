  ...
  endpoints: {
    signInWithSteam: createAuthEndpoint(
      "/sign-in/steam",
      {
        ...
        body: z.object({
          ...
          disableRedirect: z.boolean().meta({ description: "Whether to disable redirect" }).optional(),
    ...
    steamCallback: createAuthEndpoint(
      "/steam/callback",
      {
        method: "GET",
        query: z.object({
          email: z.string().meta({ description: "The email to use for the user" }).optional(),
          errorCallbackURL: z.string().meta({
            description: "The URL to redirect to if an error occurs"
          }).optional(),
          callbackURL: z.string().meta({
      ...
      async (ctx) => {
        ...
        const verifyRes = await betterFetch(
